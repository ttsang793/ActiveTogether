...
export default function Introduction() {
  return (
    <main className="user-main blog-article intro-article">
      ...
      <div className="paragraph intro-paragraph">
        <div className="row">        
          ...
          <div className="col">
            <h2>Sứ mệnh của Active Together</h2>
      ...
      <div className="quotes intro-paragraph">
        <div className="sponsor-list">
          <h2 className="fw-bold fst-italic text-center">Các thương hiệu liên kết</h2>
          <div className="sponsor">
            <img src="/src/images/sponsor/adidas.jpg" alt="Sponsor" />
            <img src="/src/images/sponsor/puma.jpg" alt="Sponsor" />
            <img src="/src/images/sponsor/yonex.jpg" alt="Sponsor" />
            <img src="/src/images/sponsor/bitis.jpg" alt="Sponsor" />
            <img src="/src/images/sponsor/dong_luc.webp" alt="Sponsor" />
            <img src="/src/images/sponsor/grand_sport.jpg" alt="Sponsor" />
          </div>
        </div>
